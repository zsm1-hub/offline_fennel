...
addpath('/export/home/zzh/romstools_writing/Roms_tools/Nesting_tools')
...
%addpath([tools_path,'ForInterann'])  %added by lwx
%addpath([tools_path,'ForInterann/Aforc_NCEP'])  %added by lwx
%addpath([tools_path,'ForInterann/Oforc_OGCM'])  %added by lwx
addpath([tools_path,'crocotools_param_TWS_offline_fennel'])  %added by lwx
addpath(genpath([tools_path,'matlab']))  % added by lwx
addpath(genpath([matpath,'matlab']))
%addpath(genpath([matpath,'delft3d'])) %zsm for delft
addpath([tools_path,'Preprocessing_tools/biology/fennel']) % lwx ,for biology
addpath(genpath([tools_path,'matlab_zsm']))  %added by zsm
addpath([tools_path,'CROCO_FILES/TWS2/'])
%addpath([tools_path,'Aforc_QuikSCAT'])
%
%-------------------------------------------------------
%
