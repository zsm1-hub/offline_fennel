...
%
zroms=zlevs(h,0.*h,theta_s,theta_b,hc,N,'r',vtransform); %lwx added var 'vtransform'
...
%
  ...
  zroms=zlevs(h,zeta,theta_s,theta_b,hc,N,'r',vtransform);%lwx added var 'vtransform'
